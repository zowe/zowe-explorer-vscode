...
async function createGlobalMocks() {
    ...
    Object.defineProperty(Profiles, "getInstance", {
        value: jest.fn(() => {
            return {
                ...
                checkCurrentProfile: jest.fn().mockReturnValue({name: globalMocks.testProfile.name, status: "active"}),
    ...
    Object.defineProperty(profileUtils, "getValidSession", { value: jest.fn().mockResolvedValue(globalMocks.testSession), configurable: true });
...
describe("ZoweJobNode unit tests - Function editSession", () => {
    ...
    it("Tests that editSession is executed successfully ", async () => {
        ...
        await blockMocks.testJobsProvider.editSession(blockMocks.jobNode, blockMocks.testJobsProvider);
