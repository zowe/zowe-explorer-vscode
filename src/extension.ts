...
function initDatasetProvider(context: vscode.ExtensionContext, datasetProvider: IZoweTree<IZoweDatasetTreeNode>) {
    ...
    vscode.commands.registerCommand("zowe.pattern", async (node) => datasetProvider.filterPrompt(node));
    vscode.commands.registerCommand("zowe.editSession", async (node) => datasetProvider.editSession(node, datasetProvider));
    ...
    vscode.commands.registerCommand("zowe.removeSession", async (node) => datasetProvider.hideSession(node));
    ...
    vscode.commands.registerCommand("zowe.disableValidation", async (node) => Profiles.getInstance().disableValidation(node, datasetProvider));
    vscode.commands.registerCommand("zowe.enableValidation", async (node) => Profiles.getInstance().enableValidation(node, datasetProvider));
...
function initUSSProvider(context: vscode.ExtensionContext, ussFileProvider: IZoweTree<IZoweUSSTreeNode>) {
    ...
    vscode.commands.registerCommand("zowe.uss.fullPath", async (node: IZoweUSSTreeNode) => ussFileProvider.filterPrompt(node));
    ...
    vscode.commands.registerCommand("zowe.uss.removeSession", async (node: IZoweUSSTreeNode) => ussFileProvider.hideSession(node));
    ...
    vscode.commands.registerCommand("zowe.uss.disableValidation", async (node) => Profiles.getInstance().disableValidation(node, ussFileProvider));
    vscode.commands.registerCommand("zowe.uss.enableValidation", async (node) => Profiles.getInstance().enableValidation(node, ussFileProvider));
    vscode.workspace.onDidChangeConfiguration((e) => {
...
function initJobsProvider(context: vscode.ExtensionContext, jobsProvider: IZoweTree<IZoweJobTreeNode>) {
    ...
    vscode.commands.registerCommand("zowe.removeJobsSession", (job) => jobsProvider.hideSession(job));
    ...
    vscode.commands.registerCommand("zowe.setJobSpool", async (session, jobid) => {
        const sessionNode: IZoweJobTreeNode = jobsProvider.mSessionNodes.find((jobNode) => jobNode.label.trim() === session.trim());
    ...
    vscode.commands.registerCommand("zowe.jobs.search", async (node) => jobsProvider.filterPrompt(node));
    ...
    vscode.commands.registerCommand("zowe.jobs.disableValidation", async (node) => Profiles.getInstance().disableValidation(node, jobsProvider));
    vscode.commands.registerCommand("zowe.jobs.enableValidation", async (node) => Profiles.getInstance().enableValidation(node, jobsProvider));
    vscode.workspace.onDidChangeConfiguration((e) => {
