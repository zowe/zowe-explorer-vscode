...
- Updated `vscePromptApi.promptForProfile` function implementations to deprioritize project level configurations and disable profile creation for the install. [#4224](https://github.com/zowe/zowe-explorer-vscode/pull/4224)
