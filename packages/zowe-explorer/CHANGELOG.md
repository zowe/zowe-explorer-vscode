...
- Fixed the issue that caused removed favorite profiles to persist between IDE sessions [#1144](https://github.com/zowe/vscode-extension-for-zowe/issues/1144). Thanks @lauren-li
