...
- Added a new VS Code toggle setting that allows users to show or hide hidden files in the USS tree view.[#3912](https://github.com/zowe/zowe-explorer-vscode/issues/3912)
