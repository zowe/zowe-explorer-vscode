...
- Updated minimum VS Code version from 1.79 to 1.90. We have decided to drop support for VS Code releases that bundle versions of Node.js no longer receiving security updates.
