...
- Fixed failure to refresh token value after user logs in to authentication after token expiration. [#2638](https://github.com/zowe/vscode-extension-for-zowe/issues/2638)
