...
- Fixed an issue with mismatch etag error returned not triggering the compare editor and possible loss of data due to the issue. [#2277](https://github.com/zowe/vscode-extension-for-zowe/issues/2277)
