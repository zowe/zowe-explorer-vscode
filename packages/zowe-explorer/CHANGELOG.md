...
- Fixed an issue where pasting data sets failed with "e.getChildren is not a function" when using extenders that don't support allocateLikeDataSet. [#4107](https://github.com/zowe/zowe-explorer-vscode/pull/4107)
