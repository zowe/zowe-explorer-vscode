...
- Added support for Kubernetes secrets as an alternative to using Keytar as the credential manager for storing Zowe credentials. [#1963](https://github.com/zowe/vscode-extension-for-zowe/issues/1963)
