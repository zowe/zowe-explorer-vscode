...
- Fix an issue where creating or writing to a file from a Zowe Explorer virtual workspace would fail. [#4426](https://github.com/zowe/zowe-explorer-vscode/pull/4426)
