...
- Fixed an issue where opening a PDS member from the table view would fail with a file not found error, if the PDS had not been expanded in the tree. [#4469](https://github.com/zowe/zowe-explorer-vscode/pull/4469)
