...
- Fixed an issue where renaming a PDS member to a name that already exists would display the URI-encoded form of the member name (e.g., `%23TEST`) instead of the decoded form (e.g., `#TEST`) in the error message. [#4468](https://github.com/zowe/zowe-explorer-vscode/issues/4468)
