...
- Provide users with the option to upload binary files by implementing a "Upload Files (Binary)" right-click option in the USS tree. [#2848](https://github.com/zowe/zowe-explorer-vscode/pull/2848)
