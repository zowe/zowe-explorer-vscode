...
- Fixed an issue where data sets and USS files might honor illegal characters in their respective names. [#4501](https://github.com/zowe/zowe-explorer-vscode/pull/4501)
