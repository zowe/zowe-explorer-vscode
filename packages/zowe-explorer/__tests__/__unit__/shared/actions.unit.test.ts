...
describe("Shared Actions Unit Tests - Function searchForLoadedItems", () => {
    ...
    it("Checking that searchForLoadedItems works for a PDS", async () => {
        ...
        await sharedActions.searchInAllLoadedItems(
    ...
    it("Checking that searchForLoadedItems works for a member", async () => {
        ...
        blockMocks.testDatasetTree.getChildren.mockReturnValue([
            blockMocks.datasetSessionNode,
        ]);
        ...
        expect(blockMocks.testDatasetTree.addSearchHistory).toBeCalledWith(
            "HLQ.PROD2.STUFF(TESTMEMB)"
        );
    });
    it("Checking that searchForLoadedItems works for a USS folder", async () => {
        ...
        jest.spyOn(folder, "getProfileName").mockImplementationOnce(
            () => "firstName"
        );
        jest.spyOn(blockMocks.ussSessionNode, "getChildren").mockResolvedValueOnce([
            folder,
        ]);
    ...
    it("Checking that searchForLoadedItems works for a USS file", async () => {
        ...
        expect(blockMocks.testUssTree.addSearchHistory).toBeCalledWith(
            "/folder/file"
        );
...
describe("Shared Actions Unit Tests - Function openRecentMemberPrompt", () => {
    ...
    it("Tests that openRecentMemberPrompt (opening a recent member) is executed successfully on a PDS", async () => {
        ...
        await sharedActions.openRecentMemberPrompt(
            blockMocks.testDatasetTree,
            blockMocks.testUSSTree
        );
