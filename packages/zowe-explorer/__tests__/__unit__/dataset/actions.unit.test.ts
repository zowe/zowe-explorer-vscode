...
describe("Dataset Actions Unit Tests - Function refreshPS", () => {
    ...
    it("Checking common PS dataset refresh", async () => {
        ...
        expect(mocked(vscode.workspace.openTextDocument)).toHaveBeenCalledWith(documentFilePath);
...
describe("Dataset Actions Unit Tests - Function deleteDataset", () => {
    ...
    it("Checking common PS dataset deletion", async () => {
        ...
        expect(mocked(fs.unlinkSync)).toHaveBeenCalledWith(path.join(globals.DS_DIR, node.getSessionNode().label.toString(), node.label.toString()));
    });
    ...
    it("Checking Favorite PDS dataset deletion", async () => {
        ...
        expect(mocked(fs.existsSync)).toHaveBeenCalledWith(path.join(globals.DS_DIR, parent.getSessionNode().label.toString(), "HLQ.TEST.NODE"));
        expect(mocked(fs.unlinkSync)).toHaveBeenCalledWith(path.join(globals.DS_DIR, parent.getSessionNode().label.toString(), "HLQ.TEST.NODE"));
    });
...
describe("Dataset Actions Unit Tests - Function saveFile", () => {
    ...
    it("Checking common dataset saving", async () => {
        ...
        expect(globalMocks.concatChildNodes).toHaveBeenCalledWith([blockMocks.testDatasetTree.mSessionNodes[0]]);
        ...
        expect(globalMocks.statusBarMsgSpy).toHaveBeenCalledWith("success", globals.STATUS_BAR_TIMEOUT_MS);
    ...
    it("Checking favorite dataset saving", async () => {
        ...
        expect(globalMocks.concatChildNodes).toHaveBeenCalledWith([blockMocks.testDatasetTree.mFavorites[0]]);
        expect(globalMocks.statusBarMsgSpy).toHaveBeenCalledWith("success", globals.STATUS_BAR_TIMEOUT_MS);
    });
...
describe("Dataset Actions Unit Tests - Function copyDataSets", () => {
    ...
    it("Testing downloadDs() called with invalid node", async () => {
        ...
        expect(mocked(Gui.errorMessage)).toHaveBeenCalledWith("Cannot download, item invalid.");
    });
