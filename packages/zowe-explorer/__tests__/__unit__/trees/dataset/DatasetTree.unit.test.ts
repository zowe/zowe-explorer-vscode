...
import { DatasetTree, ZoweDatasetNode, DatasetUtils } from "../../../../src/trees/dataset";
import { ZoweExplorerApiRegister } from "../../../../src/extending";
import { Profiles, Workspace, SettingsConfig, Constants } from "../../../../src/configuration";
...
import { ZowePersistentFilters, ZoweLocalStorage, ZoweLogger } from "../../../../src/tools";
import { SharedActions, SharedTreeProviders, SharedUtils } from "../../../../src/trees/shared";
...
function createGlobalMocks() {
    ...
    Object.defineProperty(Workspace, "closeOpenedTextFile", { value: jest.fn(), configurable: true });
...
describe("Dataset Tree Unit tests - Function initializeFavChildNodeForProfile", () => {
    ...
    it("Checking function for sequential DS favorite", async () => {
        ...
        const favChildNodeForProfile = await testTree.initializeFavChildNodeForProfile("BRTVS99.PS", Constants.DS_DS_CONTEXT, favProfileNode);
...
describe("Dataset Tree Unit Tests - Function datasetFilterPrompt", () => {
    ...
    it("Checking function on favorites", async () => {
        ...
        favoriteSearch.contextValue = Constants.DS_SESSION_CONTEXT + Constants.FAV_SUFFIX;
    ...
    it("Checking adding of new filter error is caught on getChildren", async () => {
        ...
        const errorSpy = jest.spyOn(ProfilesUtils, "errorHandling");
...
describe("Dataset Tree Unit Tests - Function rename", () => {
    ...
    it("Tests that rename() renames a node", async () => {
        ...
        mocked(Workspace.closeOpenedTextFile).mockResolvedValueOnce(false);
