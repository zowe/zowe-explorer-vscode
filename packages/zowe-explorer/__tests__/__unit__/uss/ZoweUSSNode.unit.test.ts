...
async function createGlobalMocks() {
    ...
    ZoweExplorerApiRegister.getUssApi = globalMocks.getUssApiMock.bind(
        ZoweExplorerApiRegister
    );
    ...
    Object.defineProperty(zowe, "Delete", {
        value: globalMocks.Delete,
        configurable: true,
    });
    Object.defineProperty(fs, "existsSync", {
        value: globalMocks.existsSync,
        configurable: true,
    });
    Object.defineProperty(globalMocks.Delete, "ussFile", {
        value: globalMocks.ussFile,
        configurable: true,
    });
...
describe("ZoweUSSNode Unit Tests - Function node.refreshUSS()", () => {
    async function createBlockMocks(globalMocks) {
        ...
        newMocks.ussNodeFav.contextValue =
        ...
        Object.defineProperty(newMocks.node, "isDirtyInEditor", {
            get: globalMocks.isDirtyInEditor,
        });
        Object.defineProperty(newMocks.node, "openedDocumentInstance", {
            get: globalMocks.openedDocumentInstance,
        });
...
describe("ZoweUSSNode Unit Tests - Function node.setBinary()", () => {
    it("Tests that node.setBinary() works", async () => {
        ...
        expect(subNode.contextValue).toEqual(
...
describe("ZoweUSSNode Unit Tests - Function node.getChildren()", () => {
    ...
    it("Tests that error is thrown when node label is blank", async () => {
        ...
        expect(blockMocks.rootNode.getChildren()).rejects.toEqual(
            Error("Invalid node")
        );
    });
...
describe("ZoweUSSNode Unit Tests - Function node.openUSS()", () => {
    ...
    it("Tests that node.openUSS() is executed successfully", async () => {
        ...
        expect(globalMocks.isFileTagBinOrAscii.mock.calls[0][0]).toBe(
            globalMocks.session
        );
        ...
        expect(globalMocks.openTextDocument.mock.calls[0][0]).toBe(
            node.getUSSDocumentFilePath()
        );
        expect(globalMocks.showTextDocument.mock.calls.length).toBe(1);
