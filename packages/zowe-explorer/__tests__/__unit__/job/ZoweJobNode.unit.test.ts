...
describe("ZoweJobNode unit tests - Function addSession", () => {
    it("Tests that addSession adds the session to the tree", async () => {
        ...
        expect(globalMocks.testSessionNode).toBeDefined();
        expect(globalMocks.testSessionNode.label).toEqual("sestest");
        expect(globalMocks.testSessionNode.tooltip).toEqual("sestest - owner: fake prefix: *");
    });
...
describe("ZoweJobNode unit tests - Function deleteSession", () => {
    it("Tests that deleteSession removes the session from the tree", async () => {
        ...
        await globalMocks.testJobsProvider.deleteSession(globalMocks.testSessionNode);
...
describe("ZoweJobNode unit tests - Function getChildren", () => {
    it("Tests that getChildren returns the jobs of the session, when called on the session", async () => {
        ...
        const jobs = await globalMocks.testSessionNode.getChildren();
    ...
    it("Tests that getChildren retrieves only child jobs which match a provided searchId", async () => {
        ...
        await globalMocks.testJobsProvider.addSession("fake");
        globalMocks.testSessionNode.searchId = "JOB1234";
        globalMocks.testSessionNode.dirty = true;
    ...
    it("Tests that getChildren returns the spool files if user/owner is not defined", async () => {
        ...
        globalMocks.testSessionNode._owner = undefined;
        globalMocks.testSessionNode._prefix = "";
        globalMocks.testSessionNode._searchId = "";
        globalMocks.testSessionNode.session.ISession.user = undefined;
        const spoolFiles = await globalMocks.testJobNode.getChildren();
        expect(spoolFiles.length).toBe(1);
        expect(spoolFiles[0].label).toEqual("STEP:STDOUT(101)");
...
describe("ZoweJobNode unit tests - Function flipState", () => {
    it("Tests that flipState is executed successfully", async () => {
        ...
        await globalMocks.testJobsProvider.flipState(globalMocks.testSessionNode, true);
        expect(JSON.stringify(globalMocks.testSessionNode.iconPath)).toContain("folder-root-unverified-closed.svg");
        await globalMocks.testJobsProvider.flipState(globalMocks.testSessionNode, false);
        expect(JSON.stringify(globalMocks.testSessionNode.iconPath)).toContain("folder-root-unverified-closed.svg");
        await globalMocks.testJobsProvider.flipState(globalMocks.testSessionNode, true);
        expect(JSON.stringify(globalMocks.testSessionNode.iconPath)).toContain("folder-root-unverified-closed.svg");
...
describe("ZoweJobNode unit tests - Function addFavorite", () => {
    ...
    it("Tests that addFavorite successfully favorites a search", async () => {
        ...
        globalMocks.testJobsProvider.mFavorites = [];
        globalMocks.testSessionNode.owner = "myHLQ";
        globalMocks.testSessionNode.prefix = "*";
        globalMocks.testSessionNode.contextValue = globals.JOBS_SESSION_CONTEXT;

        await globalMocks.testJobsProvider.addFavorite(globalMocks.testSessionNode);
        const profileNodeInFavs: IZoweJobTreeNode = globalMocks.testJobsProvider.mFavorites[0];
...
describe("ZoweJobNode unit tests - Function saveSearch", () => {
    async function createBlockMocks(globalMocks) {
        const testSession = globalMocks.testSessionNode.getSession();
        const newMocks = {
            testSession,
            testJobNode: new Job(
                "MYHLQ(JOB1283) - Input",
...
describe("ZoweJobNode unit tests - Function searchPrompt", () => {
    ...
    it("Testing that searchPrompt is successfully executed when searching by owner, VSCode route", async () => {
        ...
        await globalMocks.testJobsProvider.searchPrompt(globalMocks.testSessionNode);

        expect(globalMocks.testSessionNode.contextValue).toEqual(globals.JOBS_SESSION_CONTEXT + "_Active");
        expect(globalMocks.testSessionNode.owner).toEqual("MYHLQ");
        expect(globalMocks.testSessionNode.prefix).toEqual("*");
        expect(globalMocks.testSessionNode.searchId).toEqual("");
    });
    ...
    it("Testing that searchPrompt is successfully executed when searching by prefix, VSCode route", async () => {
        ...
        expect(globalMocks.testSessionNode.contextValue).toEqual(globals.JOBS_SESSION_CONTEXT + "_Active");
        expect(globalMocks.testSessionNode.owner).toEqual("*");
        expect(globalMocks.testSessionNode.prefix).toEqual("STO*");
        expect(globalMocks.testSessionNode.searchId).toEqual("");
    });
    ...
    it("Testing that searchPrompt is successfully executed when searching by prefix, VSCode route with Unverified profile", async () => {
        ...
        expect(globalMocks.testSessionNode.contextValue).toEqual(globals.JOBS_SESSION_CONTEXT + "_Unverified");
        expect(globalMocks.testSessionNode.owner).toEqual("*");
        expect(globalMocks.testSessionNode.prefix).toEqual("STO*");
        expect(globalMocks.testSessionNode.searchId).toEqual("");
    });
    ...
    it("Testing that searchPrompt is successfully executed when searching by job ID, VSCode route", async () => {
        ...
        expect(globalMocks.testSessionNode.owner).toEqual("*");
        expect(globalMocks.testSessionNode.prefix).toEqual("*");
        expect(globalMocks.testSessionNode.searchId).toEqual("STO12345");
    });
    ...
    it("Testing that searchPrompt is successfully executed when user selects from the recent searches list, VSCode route", async () => {
        ...
        expect(globalMocks.testSessionNode.owner).toEqual("fake");
        expect(globalMocks.testSessionNode.prefix).toEqual("*");
    });
    ...
    it("Testing that searchPrompt from favorited search can pass session values into node in Sessions", async () => {
        ...
        globalMocks.testSessionNode.session = sessionNoCreds;
        const sessNodeNoCreds = globalMocks.testSessionNode;
    ...
    it("Testing that searchPrompt is successfully executed when searching by owner, Theia route", async () => {
        ...
        expect(globalMocks.testSessionNode.contextValue).toEqual(globals.JOBS_SESSION_CONTEXT + "_Active");
        expect(globalMocks.testSessionNode.owner).toEqual("MYHLQY");
        expect(globalMocks.testSessionNode.prefix).toEqual("*");
        expect(globalMocks.testSessionNode.searchId).toEqual("");
    });
    ...
    it("Testing that searchPrompt is successfully executed when searching by owner & prefix, Theia route", async () => {
        ...
        expect(globalMocks.testSessionNode.contextValue).toEqual(globals.JOBS_SESSION_CONTEXT + "_Active");
        expect(globalMocks.testSessionNode.owner).toEqual("MYHLQX");
        expect(globalMocks.testSessionNode.prefix).toEqual("STO*");
        expect(globalMocks.testSessionNode.searchId).toEqual("");
    });
