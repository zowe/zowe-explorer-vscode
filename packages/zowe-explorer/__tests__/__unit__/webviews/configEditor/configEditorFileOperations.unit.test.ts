...
describe("ConfigEditorFileOperations", () => {
    ...
    describe("openConfigFileWithProfile", () => {
        it("should open config file and highlight profile successfully", async () => {
            const message = {
                filePath: "/path/to/config.json",
                profileKey: "profiles.test",
            };
    ...
    "test": {
      ...
      "properties": {
        "host": "test-host"
            ...
            await fileOperations.openConfigFileWithProfile(message);

            expect(vscode.workspace.openTextDocument).toHaveBeenCalledWith(vscode.Uri.file("/path/to/config.json"));
            expect(vscode.window.showTextDocument).toHaveBeenCalledWith(mockDocument);
        });

        it("should handle nested profiles correctly", async () => {
            const message = {
                filePath: "/path/to/config.json",
                profileKey: "profiles.parent.child",
            };
  ...
  "profiles": {
    "parent": {
      ...
      "profiles": {
        ...
        it("should show information message when profile not found", async () => {
            const vscode = require("vscode");
            const message = {
                filePath: "/path/to/config.json",
                profileKey: "profiles.nonexistent",
            };
  ...
  "profiles": {
    "test": {
      "type": "zosmf"
            ...
            expect(vscode.window.showInformationMessage).toHaveBeenCalledWith('Profile "profiles.nonexistent" not found in the config file.');
        });
        ...
        it("should handle file opening errors", async () => {
            ...
            expect(vscode.window.showErrorMessage).toHaveBeenCalledWith("Error opening file: /path/to/config.json");
        });
        ...
        it("should handle empty config file", async () => {
            ...
            expect(vscode.window.showInformationMessage).toHaveBeenCalledWith('Profile "profiles.test" not found in the config file.');
        });
        ...
        it("should handle malformed JSON gracefully", async () => {
            ...
            const mockDocument = {
                getText: jest.fn().mockReturnValue("{ invalid json"),
            };
