...
export const UssLocators = {
    ...
    secondUssProfileXpath: "(//div[@id='plugin-view:zowe.uss.explorer']//div[contains(@id,'TestSeleniumProfile')])[1]",
...
export const JobsLocators = {
    ...
    secondJobsProfileXpath: "(//div[@id='zowe.jobs.explorer']//div[contains(@id,'TestSeleniumProfile')])[1]",
    ...
    secondJobsProfileBeforeHidingXpath: "(//div[@id='zowe.jobs.explorer']//div[contains(@id,'TestSeleniumProfile')])[1]",
