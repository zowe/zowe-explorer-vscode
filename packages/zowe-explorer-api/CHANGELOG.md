...
- Renamed references to "MVS Command" to "Console Command" instead for clarity. The MvsCommandHandler class is renamed to ConsoleCommandHandler. [#4300](https://github.com/zowe/zowe-explorer-vscode/issues/4300)
