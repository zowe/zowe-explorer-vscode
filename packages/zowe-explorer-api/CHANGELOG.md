...
- Added functionality for pagination in job spool files and created a key binding option to load more job spool records. [#1787](https://github.com/zowe/zowe-explorer-vscode/issues/1787)
