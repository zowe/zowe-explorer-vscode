...
- **Breaking:** Added return type of `Promise<void>` to `IZoweTree.addDsTemplate`. [#2783](https://github.com/zowe/vscode-extension-for-zowe/pull/2783).
- **Breaking:** Added return type of `Promise<void>` to `MainframeInteractions.ICommon.logout`. [#2345](https://github.com/zowe/vscode-extension-for-zowe/pull/2345).
