...
- Marked `protected _lookupParentDirectory()` method as `@deprecated` and redefined it as a `public lookupParentDirectory()` method. [#3485] (https://github.com/zowe/zowe-explorer-vscode/issues/3485)
