...
- Allow extenders to provide additional attributes for data sets with DataSetAttributesProvider. [#3730](https://github.com/zowe/zowe-explorer-vscode/pull/3730)
