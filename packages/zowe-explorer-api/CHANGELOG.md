...
- Fixed an issue where the `vscode.workspace.fs.readFile` function would return empty contents for a USS file, even if an error occurred while fetching the file from the mainframe. [#3894](https://github.com/zowe/zowe-explorer-vscode/issues/3894)
