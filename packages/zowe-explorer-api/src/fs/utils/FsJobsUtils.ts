...
export class FsJobsUtils {
    public static isJobEntry(entry: IFileSystemEntry): entry is JobEntry {
        return entry instanceof JobEntry;
    }

    public static isSpoolEntry(entry: IFileSystemEntry): entry is SpoolEntry {
        return entry instanceof SpoolEntry;
    }

    public static buildUniqueSpoolName(spool: IJobFile): string {
