...
- Fixed an issue with mismatch etag, correcting error message sent to Zowe Explorer to trigger diff editor. [#2312](https://github.com/zowe/vscode-extension-for-zowe/issues/2312)
