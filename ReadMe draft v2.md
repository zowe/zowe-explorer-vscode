...
[![](http://vsmarketplacebadge.apphb.com/rating/Zowe.vscode-extension-for-zowe.svg)](https://marketplace.visualstudio.com/items?itemName=Zowe.vscode-extension-for-zowe)
...
<p align="center">
  <br />
  <a title="Learn more about Zowe" href="https://www.zowe.org/"><img src="https://www.openmainframeproject.org/wp-content/uploads/sites/11/2019/11/zowe-color.svg" width="50%" alt="Zowe Logo" /></a>
</p>
...
* Add recall options for migrated datasets.
* Create connections with any registered profile type.
* Streamline first profile creation.

  Fixed bugs:

  * Fixed persistent data after recall functionality.
  * Fixed the delete a connection and edit a connection, regardless of profile types, functions.
  * Fixed multiple prompts when canceling an edit session.
  * Fixed failure to load optional secure fields from profiles.
  * Fixed issue when manually editing/deleting associated * profiles.
...
* **Edit a profile**: Click the **pencil** button next to the **magnifying glass** button in the explorer tree, and modify the information inside your profile.
<!-- Cont... -->
...
For information how to configure Zowe Explorer, see [Zowe Explorer Configuration](https://docs.zowe.org/stable/user-guide/ze-install.html#configuration).

## Data set use cases

Review the following use cases to understand how to work with data sets in Zowe Explorer. The list only includes the data set use cases. For the complete list of features including USS and jobs, see [Zowe Explorer Sample Use Cases](https://docs.zowe.org/stable/user-guide/ze-usage.html#sample-use-cases).
