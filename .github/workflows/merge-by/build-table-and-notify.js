...
const buildTableRow = (owner, repo, pr) =>
  `| [#${pr.number}](https://github.com/${owner}/${repo}/pull/${pr.number}) | [**${pr.title}**](https://github.com/${owner}/${repo}/pull/${pr.number}) | ${pr.author} | ${pr.mergeBy ?? "N/A"} | ${pr.hasReviews ? ":white_check_mark:" : ":white_large_square:"} |`;
