...
var parsedZoweExplorerApiRegister = JSON.parse(fs.readFileSync('./out/src/api/ZoweExplorerApiRegister.nls.metadata.json').toString());
var keysPairsZoweExplorerApiRegister = {};
...
parsedZoweExplorerApiRegister.keys.forEach((key, i) => keysPairsZoweExplorerApiRegister[key] = parsedZoweExplorerApiRegister.messages[i]);
...
parsedZoweUSSNode.keys.forEach((key, i) => keysPairsZoweUSSNode[key] = parsedZoweUSSNode.messages[i]);
 ...
 fs.writeFileSync('./i18n/sample/src/api/ZoweExplorerApiRegister.i18n.json', JSON.stringify(keysPairsZoweExplorerApiRegister, null, 4));
