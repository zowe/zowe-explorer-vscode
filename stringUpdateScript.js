...
var parsedZoweVscApiRegister = JSON.parse(fs.readFileSync('./dist/src/api/ZoweExplorerApiRegister.nls.metadata.json').toString());
...
var parsedZoweNode = JSON.parse(fs.readFileSync('./dist/src/ZoweDatasetNode.nls.metadata.json').toString());
